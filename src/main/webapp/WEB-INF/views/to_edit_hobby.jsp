...
<div class="add_name">
	<h4>
		...
		<form action="/user_springmvc_hibernate/hobby/do_edit" method="post" id="hobby_form">
		<input type="text" name="id" value="${hobbyDemo.id }" hidden="hidden"/>
			<div class="name">
				<label for="hobby_name">职业名称：</label> 
				<input type="text" name="hobby" id="hobby_name" placeholder="职业名称" value="${hobbyDemo.hobby }" required="required">
			</div>
			<hr />
			<div class="control">
